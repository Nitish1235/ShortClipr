...
TEMPLATE_RULES: dict[str, dict] = {
    ...
    "max-energy": {
        ...
        "bottom_tag_style": "Wide rounded pill tag. A hype label.",
    },
    "storytelling": {
    ...
    "meme-style": {
        ...
        "bottom_tag_style": "Rounded pill tag with meme-style phrase. Keep it relatable.",
    },
}
...
- STRICT RULE: Do NOT use emojis. FFmpeg cannot render them and they will cause visual glitches.
- top_title: complete punchy sentence, max 10 words.
- bottom_tag: max 5 words, text only.
